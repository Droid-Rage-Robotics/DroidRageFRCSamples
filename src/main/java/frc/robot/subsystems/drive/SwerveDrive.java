...
public class SwerveDrive extends SubsystemBase {
    ...
    private final ShuffleboardValue<String> tippingStateWriter = ShuffleboardValue.create(tippingState.name(), "Tipping State", SwerveDrive.class.getSimpleName()).build();
    private final ShuffleboardValue<String> speedStateWriter = ShuffleboardValue.create(speed.name(), "Speed/State", SwerveDrive.class.getSimpleName()).build();
    
    private final ShuffleboardValue<Double> headingWriter = ShuffleboardValue.create(0.0, "Gyro/Heading (Degrees)", SwerveDrive.class.getSimpleName()).build();
    private final ShuffleboardValue<Double> rollWriter = ShuffleboardValue.create(0.0, "Gyro/Roll (Degrees)", SwerveDrive.class.getSimpleName()).build();
    private final ShuffleboardValue<Double> pitchWriter = ShuffleboardValue.create(0.0, "Gyro/Pitch (Degrees)", SwerveDrive.class.getSimpleName()).build();
    private final ShuffleboardValue<String> locationWriter = ShuffleboardValue.create("", "Robot Location", SwerveDrive.class.getSimpleName()).build();

    private final ShuffleboardValue<Double> frontLeftTurnPositionWriter = ShuffleboardValue.create(0.0, "Swerve Modules/Front Left/Turn Position (Radians)", SwerveDrive.class.getSimpleName()).build();
    private final ShuffleboardValue<Double> frontLeftDriveDistanceWriter = ShuffleboardValue.create(0.0, "Swerve Modules/Front Left/Drive Position (Radians)", SwerveDrive.class.getSimpleName()).build();

    private final ShuffleboardValue<Double> frontRightTurnPositionWriter = ShuffleboardValue.create(0.0, "Swerve Modules/Front Right/Turn Position (Radians)", SwerveDrive.class.getSimpleName()).build();
    private final ShuffleboardValue<Double> frontRightDriveDistanceWriter = ShuffleboardValue.create(0.0, "Swerve Modules/Front Right/Drive Position (Radians)", SwerveDrive.class.getSimpleName()).build();
    
    private final ShuffleboardValue<Double> backLeftTurnPositionWriter = ShuffleboardValue.create(0.0, "Swerve Modules/Back Left/Turn Position (Radians)", SwerveDrive.class.getSimpleName()).build();
    ...
    private final ShuffleboardValue<Double> backRightTurnPositionWriter = ShuffleboardValue.create(0.0, "Swerve Modules/Back Right/Turn Position (Radians)", SwerveDrive.class.getSimpleName()).build();
    private final ShuffleboardValue<Double> backRightDriveDistanceWriter = ShuffleboardValue.create(0.0, "Swerve Modules/Back Right/Drive Position (Radians)", SwerveDrive.class.getSimpleName()).build();

    private final ShuffleboardValue<Boolean> isEnabled = ShuffleboardValue.create(true, "Is Drive Enabled", SwerveDrive.class.getSimpleName())
        .withWidget(BuiltInWidgets.kToggleSwitch)
        .build();

    private final ShuffleboardValue<Double> forwardVelocityWriter = ShuffleboardValue.create(0.0, "Forward Velocity Writer", SwerveDrive.class.getSimpleName()).build();
